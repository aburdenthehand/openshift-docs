...
Use the Containerized Data Importer (CDI) to import the container disk into a PVC by using a data volume. You can then attach the DataVolume to a virtual machine for persistent storage.
