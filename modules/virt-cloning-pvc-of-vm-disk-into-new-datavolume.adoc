...
into a new data volume. The new DataVolume can then be used for a new virtual
machine.
...
. Create a YAML file for a data volume object that specifies the name of the
