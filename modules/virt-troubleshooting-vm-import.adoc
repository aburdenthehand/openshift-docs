...
** If you created a custom config map, check the ConfigMap to verify that the RHV VM operating system is mapped to a matching {VirtProductName} common template.
