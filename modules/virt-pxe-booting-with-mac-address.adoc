...
the network attachment definition in your virtual machine instance configuration
...
. Create the network attachment definition object by using the file you created
...
to the network attachment definition called `<pxe-net-conf>`:
+
[source,yaml]
----
networks:
