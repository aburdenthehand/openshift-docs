...
If the defined storage class does not match a StorageClass in the cluster, then
the default storage class defined for the cluster is used. If there is no
default storage class defined in the cluster, the StorageClass used to provision
