...
= Creating a new virtual machine from a cloned persistent volume claim by using a data volumeTemplate

You can create a virtual machine that clones the persistent volume claim (PVC) of
an existing virtual machine into a data volume. By referencing a
...
[NOTE]
====
When a data volume is created as part of the data volumeTemplate of a virtual
